...
1. pokedex/
  1.1. index.html -> (página principal)
  1.2. css/
   1.2.1. styles.css -> (estilos de la aplicación)
  1.3. js/
   1.3.1app.js -> (lógica de la aplicación)
  1.4. assets/ -> (imágenes, fuentes, etc.)
...
## ☁️ Paso 2: Crear recurso en Azure Portal
